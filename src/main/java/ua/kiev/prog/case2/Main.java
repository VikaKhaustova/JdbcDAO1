...
public class Main {
    public static void main(String[] args) throws SQLException {
        try (Connection conn = ConnectionFactory.getConnection())
        {
            ...
            System.out.println("records with all columns");
            for (Client cli : list)
            ...
            List<Client> filteredList1 = dao.getAll(Client.class, "name", "age");
            List<Client> filteredList2 = dao.getAll(Client.class, "age");
            System.out.println("records with specific columns: name and age");
            for (Client cli : filteredList1)
                System.out.println(cli);
            System.out.println("records with specific column: age");
            for (Client cli : filteredList2)
                System.out.println(cli);
